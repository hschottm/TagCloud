...
1. Copy the content of this folder in <ILIAS_directory>/Customizing/global/plugins/Services/Repository/RepositoryObject/TagCloud
...
5. Look for the TagCloud (tagcloud) plugin on the table and hit the "update" link.
...
8. Now, you can create new tag clouds.